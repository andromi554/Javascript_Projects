...
async function fetchRepositories(repos_url){
  ...
  try{
    const response = await fetch(repos_url + "?per_page=6");
...
function displayUserData(user){
  ...
  bioElement.textContent = user.bio || "No bio avalable";
  ...
  // followers.textContent.style.marginRight = "5px";
  followers.style.marginLeft = "5px";
